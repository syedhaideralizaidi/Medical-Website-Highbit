...
const Olfaction= (props)=> {
  ...
  const handleClickbtn = () => {
    ...
    //console.log("Hello I am haider,checking amount ",amount);

    //Axios.post("http://localhost:5000/checkout",obj)
    obj["Order"]['UserId']=location.state.id;
   ...
   },
   {
    ...
    Axios.post(api,obj).then(res=>{
          ...
          navigate('/Payment',{state:{id:1,name:location.state.name,address:location.state.address,responses:res.data}});
          newobj=res.data;
        })
       // console.log("obj",obj)
